...
public class TelaInicial extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_ad_equip) {
            Intent it = new Intent(this, AdicionarEquipamento.class);
            startActivity(it);
        } else if (id == R.id.nav_equip) {
            Intent it = new Intent(this, Equips.class);
            startActivity(it);
        } else if (id == R.id.nav_px_manut) {
            Intent it = new Intent(this, PxManut.class);
            startActivity(it);
        } else if (id == R.id.nav_dicas) {
            Intent it = new Intent(this, Dicas.class);
            startActivity(it);
